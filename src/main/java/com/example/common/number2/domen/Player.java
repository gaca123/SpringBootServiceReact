...
public class Player implements Comparable<Player> {
    ...
    @Attributes(required = true, title = "active", description = "Pick player status", readonly = false)
    ...
    public boolean getPlayerStatusCheck() {
        return playerStatusCheck;
    }

    public void setPlayerStatusCheck(boolean playerStatusCheck) {
